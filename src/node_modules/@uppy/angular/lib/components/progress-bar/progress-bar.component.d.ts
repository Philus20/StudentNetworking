...
export declare class ProgressBarComponent extends UppyAngularWrapper implements OnDestroy, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ProgressBarComponent, "uppy-progress-bar", never, { "uppy": { "alias": "uppy"; "required": false; }; "props": { "alias": "props"; "required": false; }; }, {}, never, never, false, never>;
}
