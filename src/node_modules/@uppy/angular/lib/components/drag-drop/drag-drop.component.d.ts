...
export declare class DragDropComponent extends UppyAngularWrapper implements OnDestroy, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DragDropComponent, "uppy-drag-drop", never, { "uppy": { "alias": "uppy"; "required": false; }; "props": { "alias": "props"; "required": false; }; }, {}, never, never, false, never>;
}
