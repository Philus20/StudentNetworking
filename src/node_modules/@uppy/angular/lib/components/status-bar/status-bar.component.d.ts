...
export declare class StatusBarComponent extends UppyAngularWrapper implements OnDestroy, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<StatusBarComponent, "uppy-status-bar", never, { "uppy": { "alias": "uppy"; "required": false; }; "props": { "alias": "props"; "required": false; }; }, {}, never, never, false, never>;
}
