...
export declare class DashboardComponent extends UppyAngularWrapper implements OnDestroy, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DashboardComponent, "uppy-dashboard", never, { "uppy": { "alias": "uppy"; "required": false; }; "props": { "alias": "props"; "required": false; }; }, {}, never, never, false, never>;
}
